...
Se o usuário estiver satisfeito, peça para ele clicar no botão de ir para o próximo agente
(outro agente que vai coletar mais informaçãoes detalhadas).

Sempre leia o SPECIFICATION.md antes de mandar para o próximo agente para saber o texto está
correto, bem preenchido e elaborado depois da escrita.
""".strip()